    ...
    >
      <Card className="bg-gradient-to-br from-purple-50 to-teal-50 border-purple-200 shadow-lg">
        ...
        <CardContent className="space-y-4">
          {/* Best Next Task */}
          <div className="p-4 bg-white rounded-xl border-2 border-purple-300 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-3 bg-green-50 rounded-lg border border-green-200">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs text-gray-600">{recommendations.quick_win.estimated_time}m</span>
              </div>
            ...
            <div className="p-3 bg-orange-50 rounded-lg border border-orange-200">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs text-gray-600">{recommendations.challenging.estimated_time}m</span>
              </div>
              <h5 className="font-semibold text-sm text-gray-900 mb-1">
