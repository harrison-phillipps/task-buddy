                  ...
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    ...
                    {provider === 'outlook' ? (
                      <svg viewBox="0 0 24 24" className="w-6 h-6">
                        ...
                        <path fill="#fff" d="M12 6.5C9.515 6.5 7.5 8.515 7.5 11S9.515 15.5 12 15.5 16.5 13.485 16.5 11 14.485 6.5 12 6.5zm0 7c-1.38 0-2.5-1.12-2.5-2.5S10.62 8.5 12 8.5s2.5 1.12 2.5 2.5S13.38 13.5 12 13.5zM6 17h12v1H6z"/>
                      </svg>
                    ) : (
                      <svg viewBox="0 0 24 24" className="w-6 h-6">
